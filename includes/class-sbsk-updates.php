			...
			<div class="sbsk-updates">
				...
				<div class="sbsk-updates__actions">
					...
					if ( $pending && current_user_can( 'update_plugins' ) ) :
						?>
						<a class="button button-primary" href="<?php echo esc_url( wp_nonce_url( self_admin_url( 'update-core.php?action=do-plugin-upgrade&plugins=' . rawurlencode( $file ) ), 'upgrade-core' ) ); ?>"><?php esc_html_e( 'Update now', 'sb-site-kit' ); ?></a>
					<?php endif; ?>
